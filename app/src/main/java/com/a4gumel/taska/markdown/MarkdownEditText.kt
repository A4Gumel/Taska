package com.a4gumel.taska.markdown
...
import com.a4gumel.taska.model.KeyMovementMethod
...
class MarkdownEditText : AppCompatEditText {
    ...
    var taskBoxColor: Int = ResourcesCompat.getColor(resources, R.color.text_primary, context.theme)
    var taskBoxBackgroundColor: Int =
        ResourcesCompat.getColor(resources, R.color.purple5, context.theme)
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(
        context,
        attrs,
        io.noties.markwon.ext.strikethrough.R.attr.editTextStyle
    ) {
        markwon = markwonBuilder(context)
    }
    ...
    private fun markwonBuilder(context: Context): Markwon {
        movementMethod = KeyMovementMethod().getMyInstance()
